...
public partial class REPORTS_Ledger_Updated : System.Web.UI.Page
{
    ...
    protected void LoadReport(object sender, EventArgs e)
    {
        ...
        string rptName = "TrialBalanceNew.rpt";
              var BranchID = "";
             ...
             DataSet ds = AACommon.ReturnDatasetBySPForREPORT("CONTROL_ACC_BALANCE_TRIAL_BALANCE", "VW_CONTROL_ACC_BALANCE", Con, Branch, DateFrom, DateEnd);
