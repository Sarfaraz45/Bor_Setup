<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="StockReportWareHouseMaster_2.aspx.cs" Inherits="REPORTS_Ledger_Updated" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span><b id="MainTitle" runat="server"> Stock Report (WareHouse ShowRoom) </b></h3>
...
<div class="col-md-4"><asp:DropDownList ID="ddlITEM" runat="server" DataSourceID="SqlDataSource1" DataTextField="ITEMName" DataValueField="ITEMID" CssClass="chzn-select form-control"  AutoPostBack="true"></asp:DropDownList></div>
                                ...
                                <SelectParameters>
                                    ...
                                    <asp:ControlParameter ControlID="ddlBrand" Name="BrandID" 
                                        PropertyName="SelectedValue" Type="String" />
                                            ...
                                            SelectCommand="SELECT '0' as [CatID],' -- SELECT ALL CATEGORY -- ' as [CatTitle] FROM [Category] UNION  SELECT   [CatID], [CatTitle] FROM [Category] where IsDelete=0 Order by CatTitle"> </asp:SqlDataSource>
                                              <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Con %>" 
                                            SelectCommand="SELECT '0' as [BrandID],' -- SELECT ALL BRAND -- ' as [BrandTitle] FROM [Brand] UNION  SELECT   [BrandID], [BrandTitle] FROM [Brand] where IsDelete=0 Order by BrandTitle"> </asp:SqlDataSource>
