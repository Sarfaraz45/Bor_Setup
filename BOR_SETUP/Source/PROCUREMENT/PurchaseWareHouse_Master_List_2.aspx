<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PurchaseWareHouse_Master_List_2.aspx.cs" Inherits="PROCUREMENT_PO_LIST" %>
...
<!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Transfer Order IN LIST (USER)</h3>
...
<!-- vd_panel-menu --> 
                ...
                <div class="row">
                                ...
                                <asp:HyperLink ID="HyperLink2" NavigateUrl="~/PROCUREMENT/PurchaseWareHouse_Master_2.aspx" runat="server">Add New Transfer User IN</asp:HyperLink>
                                </div>
                                <div class="col-md-12" style="height:20px;"></div>
                                  <div class="col-md-12">
                             <input type="text" class="span6 typeahead form-control" placeholder="SEARCH BY TRANSFER ORDER NUMBER AND  DATE"  onblur="javascript:LoadLISTSearch(this);"  style="overflow:visible;" id="txtAccCode1"  data-provide="typeahead" style="width:100%" 
                                             data-items="10" >
                             </div>
                             <div class="col-md-12" style="height:20px;"></div>
                             <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List_2.aspx/LOAD_ITEMS',
            data: '{ "UserID" : "' + UserID + '" }',
    ...
    function LoadLIST() {
       ...
       // alert('ddddddddd');
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List_2.aspx/LoadLIST',
            data: '{ "UserID" : "' + UserID + '" }',
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (msg) {
    ...
    function LoadLISTSearch(a) {        
        ...
        var res = txtAccCode.substring(13, 33);        
        ...
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List_2.aspx/LoadLISTSearch',
            data: '{ "UserID" : "' + UserID + '","PaymentType" : "' + PaymentType + '"  }',
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (msg) {
                var s = msg.d;
