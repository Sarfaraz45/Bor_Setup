<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterUser.master" AutoEventWireup="true" CodeFile="PO_Local_User.aspx.cs" Inherits="PROCUREMENT_PO" %>
                            ...
                            <div class="col-lg-4">
                                ...
                                <asp:DropDownList ID="ddlSupplier" runat="server" DataSourceID="SqlDataSource1"  CssClass="chzn-select form-control"
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                            ...
                                            SelectCommand="SELECT AccountsID, AccountsTitle FROM [VW_ACCOUNTS_NAME_WITH_BALANCE] where BranchID1=@BranchID">
                                            <SelectParameters>
...
<script type="text/javascript">
    ...
    function GetRMB() {
        ...
        $.ajax({
            type: "POST",
            url: "PO_Local_User.aspx/LoadRMbValue",
            data: dataToSend,            
            dataType: "json",
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PO_Local_User.aspx/LOAD_ITEMS',
    ...
    function SaveTransaction() {
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'PO_Local_User.aspx/SaveTransaction',
                //data: {},
