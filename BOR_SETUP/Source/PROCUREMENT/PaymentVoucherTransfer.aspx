<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PaymentVoucherTransfer.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Payment Voucher (Branch to Branch)</h3>
...
<!-- vd_panel-menu --> 
                        ...
                        <div class="row">
                         <div class="col-md-12">                        
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">SELECT BRANCH FOR TRANSFER</label>
                      </div> 
                         <div class="col-md-12">                        
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Con %>" 
                                            SelectCommand="select '0' AS BranchID,'Select Branch for Transfer Amount' AS BranchName union SELECT   [BranchID], [BranchName] FROM [Branch] where BranchID!=@BranchID Order by BranchID">
                                            <SelectParameters>
                        ...
                        <div class="col-md-12">                        
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">TRANSFER FROM (CURRENT BRANCH)</label>
                      </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">                        
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">TRANSFER FROM DETAIL (CURRENT BRANCH)</label>
                      </div>        
                      ...
                      <div class="col-md-6">                        
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">TRANSFER TO (RECEIVE TO ACCOUNT)</label>
                      </div> 
                      <div class="col-md-6">                        
                      <label class="control-label col-md-12 col-sm-12 col-xs-12">TRANSFER TO (RECEIVE FROM ACCOUNT)</label>
                      </div> 
                         <div class="col-md-6">                        
                        <div class="col-md-12 col-sm-12 col-xs-12">
                             <asp:DropDownList ID="ddlItemFrom1" runat="server"  CssClass="chzn-select form-control"  DataSourceID="SqlDataSource3"  DataTextField="AccountsTitle" DataValueField="AccountsID"  ></asp:DropDownList> 
                        </div>
                      </div>   
                      <div class="col-md-6">                        
                        <div class="col-md-12 col-sm-12 col-xs-12">
                             <asp:DropDownList ID="ddlItemFromTo" runat="server"  CssClass="chzn-select form-control"  DataSourceID="SqlDataSource3"  DataTextField="AccountsTitle" DataValueField="AccountsID"  ></asp:DropDownList> 
                        </div>
                      </div>

                       <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Con %>" 
                            SelectCommand=" SELECT       AccountsID, AccountsTitle + ' ( ' +   convert(nvarchar(20),Round(Balance,2)) + ' ) ' + ' ^ ' + convert(Nvarchar(20), AccountsID) AS AccountsTitle FROM [VW_ACCOUNTS_NAME_WITH_BALANCE] where BranchID1=@BranchID">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "PaymentVoucherTransfer.aspx/LoadRMbValue",
            data: dataToSend,
            dataType: "json",
    ...
    function LOAD_ACCOUNTS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PaymentVoucherTransfer.aspx/LOAD_ACCOUNTS',
    ...
    function GetVoucherNo() {
        ...
        $.ajax({
            type: "POST",
            url: "PaymentVoucherTransfer.aspx/LoadNUMBER",
    ...
    function SaveTransaction() {
        ...
        var BranchID = localStorage.getItem("BranchID");
        var TransferToBranch = document.getElementById("ContentPlaceHolder1_ddlTransferToBranch").value;
        var TransferToRcvFrom = document.getElementById("ContentPlaceHolder1_ddlItemFrom1").value;
        var TransferToRcvTo = document.getElementById("ContentPlaceHolder1_ddlItemFromTo").value;
            $.ajax({
                type: 'POST',
                url: 'PaymentVoucherTransfer.aspx/SaveTransaction',
                //data: {},
                ...
                data: '{ "UserID" : "' + UserID + '", "txtVDate" : "' + txtVDate + '",  "ddlType" : "' + ddlType + '", "RMBValue" : "' + RMBValue + '", "str" : "' + str + '",  "ddlCurrency" : "' + ddlCurrency + '",  "BranchID" : "' + BranchID + '",  "TransferToBranch" : "' + TransferToBranch + '",  "TransferToRcvFrom" : "' + TransferToRcvFrom + '",  "TransferToRcvTo" : "' + TransferToRcvTo + '"}',                
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
                    tblRows = msg.d;
