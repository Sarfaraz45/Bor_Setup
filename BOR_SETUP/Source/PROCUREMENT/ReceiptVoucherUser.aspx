<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="ReceiptVoucherUser.aspx.cs" Inherits="PROCUREMENT_PO" %>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="col-md-4 control-label" style="margin-top:5px;">Date :</label>
                
                                               <label class="col-md-4 control-label" style="margin-top:5px;">Type :</label>
                                               <label class="col-md-4 control-label" style="margin-top:5px;">Currency :</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ReceiptVoucherUser.aspx/LoadRMbValue",
            data: dataToSend,
            dataType: "json",
    ...
    function LOAD_ACCOUNTS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'ReceiptVoucherUser.aspx/LOAD_ACCOUNTS',
    ...
    function GetVoucherNo() {
        ...
        $.ajax({
            type: "POST",
            url: "ReceiptVoucherUser.aspx/LoadNUMBER",
    ...
    function SaveTransaction() {
        ...
        var BranchID = localStorage.getItem("BranchID");
            $.ajax({
                type: 'POST',
                url: 'ReceiptVoucherUser.aspx/SaveTransaction',
                //data: {},
