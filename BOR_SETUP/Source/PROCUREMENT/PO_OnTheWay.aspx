<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PO_OnTheWay.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Purchase Order ( ON THE WAY ) </h3>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                             ...
                             <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                               <input type="text" id="txtRemarks" placeholder="Enter Remarks" class="form-control" />
                         ...
                         <div class="row"><div class="col-lg-12" style="height:10px"></div></div>
                                ...
                                <div class="col-lg-12 table-responsive" style="overflow:visible;">
                                    <table id="tblItems" class="table table-striped table-bordered dataTable no-footer" style="overflow:visible;">
                                        <tr>
                                            ...
                                            <th style="width:8%">Unit Price (PKR)</th>                                                                                   
                                            ...
                                            <th style="width:6%">Cost (PKR)</th>   
                                            <th style="width:6%">Cost (RMB)</th>   
                                            <th style="width:9%">Total Price (PKR)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="txtRMBPrice1" class="form-control" value="0"    style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                                            <td><input type="text" id="txtRMBPacking1" class="form-control" value="0"    style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                                            <td style="display:none;"><input type="text" id="txtCarry1" class="form-control" value="0"    style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                                            ...
                                            <td><input type="text" id="txtCostRMB1" class="form-control" value="0" disabled="disabled"  style="width:100%; border:0px none;" /></td>
                            ...
                            <div class="row" style="height:20px;"></div>
                                <label class="col-md-4 control-label"  style="display:none;">Carry Amount PKR</label>
                                <label class="col-md-4 control-label" >Packing Amount PKR</label>
                                <label class="col-md-4 control-label"  style="display:none;">Ex. Charges Amount PKR</label>
                                
                                
                                <div class="col-lg-4" style="display:none;"><input type="text" id="txtCarryPKR" class="form-control" disabled="disabled" style="width:100%;" value="0" /></div>
                                <div class="col-lg-4"><input type="text" id="txtPackingPKR" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
                                <div class="col-lg-4" style="display:none;"><input type="text" id="txtExChrgPKR" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
                            ...
                            <%-- <input type="button" id="btnClear" class="btn btn-danger btn-sm" value="Clear Form" onclick="ClearForm();" />--%>
                             <input type="button" id="btnSave" style="font-weight:bold; font-size:20px;" class="btn btn-warning btn-block" value="P R O C E S S &nbsp&nbsp&nbsp P U R C H A S E  &nbsp&nbsp&nbsp O N   &nbsp&nbsp&nbsp T H E   &nbsp&nbsp&nbsp  W A Y" onclick="SaveTransaction();" />
                             </div></div>
...
<script type="text/javascript">
    ...
    function GetRMB() {
        ...
        $.ajax({
            type: "POST",
            url: "PO_OnTheWay.aspx/LoadRMbValue",
            data: dataToSend,            
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
...
//        cell5.appendChild(txtRMBValue); //SumDbCr();
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PO_OnTheWay.aspx/LOAD_ITEMS',
    ...
    function SaveTransaction() {
        ...
        //alert("Done Successfully with Error : 0xcee984_sqlserver_prevent. Contact your Administrator");
       //location.reload();
        //return;
