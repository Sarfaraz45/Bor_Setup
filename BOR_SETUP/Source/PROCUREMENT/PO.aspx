<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true"
    CodeFile="PO.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="dvUnits" style="display: none">
    </div>
    <!-- #modal-message -->
    <!-- #modal-message -->
    <!-- #modal-message -->
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color: White; border-bottom: 1px solid #DDDDDD;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ×</button>
                    <h4 class="modal-title" style="font-weight: bold; color: red;">
                        Alert !</h4>
                </div>
                <div class="modal-body" id="modalbody" style="font-weight: bold; font-family: Calibri;
                    font-size: medium;">
                </div>
            ...
            <div class="panel widget light-widget panel-bd-top">
                <div class="panel-heading bordered">
                    <h3 class="panel-title">
                        <span class="menu-icon"><i class="icon-pie"></i></span>Purchase Order ( IMPORT )
                    </h3>
                    <div class="vd_panel-menu">
                        <div data-action="minimize" data-original-title="Minimize" data-toggle="tooltip"
                            data-placement="bottom" class=" menu entypo-icon">
                            <i class="icon-minus3"></i>
                        </div>
                        <div data-action="refresh" data-original-title="Refresh" data-toggle="tooltip" data-placement="bottom"
                            class=" menu entypo-icon smaller-font">
                            <i class="icon-cycle"></i>
                        </div>
                        <div data-action="close" data-original-title="Close" data-toggle="tooltip" data-placement="bottom"
                ...
                <div class="panel-body">
                    <div class="row" style="display: none;">
                        <div class="col-lg-12">
                            ...
                            <asp:TextBox ID="txtid" runat="server" Visible="False" CssClass="form_inputfeild"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon" id="datepicker-icon-trigger-PV" data-datepicker="#datepicker-autoClose">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Con %>"
                                        SelectCommand="SELECT AccountsID, AccountsTitle + ' ( ' +   convert(nvarchar(20),Round(Balance,2)) + ' ) ' AS AccountsTitle 
                                            FROM [VW_ACCOUNTS_NAME_WITH_BALANCE]
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Type</label>
                                <div class="col-md-9">
                                    <select id="ddlPurchaseType" class="form-control" onchange="GetRate();">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Rate</label>
                                <div class="col-md-9">
                                    <input type="text" id="txtCurrencyRate" value="0" class="form-control" onkeydown="SetRate();"
                                        onkeyup="SetRate();" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Packing Rate</label>
                                <div class="col-md-9">
                                    <input type="text" id="txtPackingRate" value="0" class="form-control" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4" style="display: none;">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Packing Account</label>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlPackingAccount" runat="server" DataSourceID="SqlDataSource1"
                                        CssClass="chzn-select form-control" DataTextField="AccountsTitle" DataValueField="AccountsID">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4" style="display: none">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Carry Account</label>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlCarryAccount" runat="server" DataSourceID="SqlDataSource1"
                                        CssClass="chzn-select form-control" DataTextField="AccountsTitle" DataValueField="AccountsID">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" style="display: none">
                            <div class="form-group">
                                <label class="col-md-3 control-label">
                                    Ex. Charges Account</label>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlExChargesAccount" runat="server" DataSourceID="SqlDataSource1"
                                        CssClass="chzn-select form-control" DataTextField="AccountsTitle" DataValueField="AccountsID">
                                    </asp:DropDownList>
                                </div>
                            </div>
                    ...
                    <div class="row" style="overflow: visible;">
                        <div class="col-lg-12 table-responsive" style="overflow: visible;">
                            <table id="tblItems" class="table table-striped table-bordered dataTable no-footer"
                                ...
                                <tr>
                                    <td>
                                        <input type="text" id="txtSr1" value="1" disabled="disabled" class="form-control"
                                            style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td>
                                        <input type="text" class="span6 typeahead form-control" onblur="javascript:fillUNITS(this);"
                                            style="border: 0px none; overflow: visible;" id="txtAccCode1" data-provide="typeahead"
                                            style="width: 100%" data-items="10">
                                    </td>
                                    <td>
                                        <select onchange='LoadDetailPrice(this)' id="ddlUnit1" class="form-control" style="width: 100%;
                                            border: 0px none;">
                                            <%--<option value="0-0">Select Unit</option>
                                    ...
                                    <td>
                                        <input type="text" id="txtQty1" class="form-control" value="1" style="width: 100%;
                                            border: 0px none;" onkeyup="tot(this);" />
                                    </td>
                                    <td>
                                        <input type="text" id="txtPrice1" class="form-control" value="0" style="width: 100%;
                                            border: 0px none;" onkeyup="tot(this);" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtRMBPrice1" class="form-control" value="0" style="width: 100%;
                                            border: 0px none;" onkeyup="tot(this);" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtRMBPrice1" class="form-control" value="0" style="width: 100%;
                                    ...
                                    <td style="display: none;">
                                        <input type="text" id="txtRMBPacking1" class="form-control" value="0" style="width: 100%;
                                            border: 0px none;" onkeyup="tot(this);" />
                                    </td>
                                    <td>
                                        <input type="date" id="txtEDate1" class="form-control" style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtCarry1" class="form-control" value="0" style="width: 100%;
                                            border: 0px none; display: none;" onkeyup="tot(this);" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtExCharge1" class="form-control" value="0" style="width: 100%;
                                            border: 0px none;" onkeyup="tot(this);" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtCostPKR1" class="form-control" value="00" disabled="disabled"
                                            style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtCostRMB1" class="form-control" value="0" disabled="disabled"
                                            style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td>
                                        <input type="text" id="txtTotalPrice1" class="form-control" value="0" disabled="disabled"
                                            style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td style="display: none;">
                                        <input type="text" id="txtRMBTotalPrice1" class="form-control" value="0" disabled="disabled"
                                            style="width: 100%; border: 0px none;" />
                                    </td>
                                    <td>
                                        <span class="glyphicon glyphicon-remove" aria-hidden="true" style="font-size: 20px;
                                            margin-left: 5px; cursor: pointer; color: Red;" onmouseover='this.style.color="gray"'
                                            onmouseout='this.style.color="Red"' title="Delete Row" id="txtDelete1" onclick="DeleteRow(this);">
                                        </span>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="col-lg-12">
                        <i class="fa fa-2x fa-plus-square" title="Press Ctrl + A for new Row" onclick="addRow();SumDbCr();">
                        </i>
                    </div>
                 
                    <div class="row" style="height: 20px;">
                    </div>
                       <label class="col-md-4 control-label" style="display:none";>
                       Carry Amount
                    </label>
                    <label class="col-md-4 control-label" style="display:none";>
                        Packing Amount
                    ...
                    <div class="col-lg-4" style="display:none";  >
                        <input type="text" id="txtCarryPKR" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-lg-4" style="display:none";>
                        <input type="text" id="txtPackingPKR" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-lg-4" style="display:none";>
                        <input type="text" id="txtExChrgPKR" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                     <div class="col-md-12" style="height:20px;"></div>
                    <label class="col-md-4 control-label" style="display:none";>Carry Amount RMB</label>
                                <label class="col-md-4 control-label" style="display:none"; >Packing Amount RMB</label>
                                <label class="col-md-4 control-label"  style="display:none";>Ex. Charges Amount RMB</label>
                    <div class="col-lg-4" style="display:none";>
                        <input type="text" id="txtCarryRMB" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-lg-4" style="display:none";>
                        <input type="text" id="txtPackingRMB" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-lg-4" style="display:none";>
                        <input type="text" id="txtExChrgRMB" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    ...
                    <div class="col-lg-3" style="display:none";>
                        <input type="text" id="txtDiscountPKR" value="0" class="form-control" style="width: 100%;"
                            onkeypress="GetDiscountRMB();" onkeydown="GetDiscountRMB();" onkeyup="GetDiscountRMB();" /></div>
                    <div class="col-lg-3" style="display:none";>
                        <input type="text" id="txtDiscountRMB" value="0" class="form-control" disabled="disabled"
                            style="width: 100%;" /></div>
                    <div class="col-lg-3" style="display:none";>
                        <input type="text" id="txtSupplierPKR" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-lg-3" style="display:none";>
                        <input type="text" id="txtSupplierRMB" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                    <div class="col-md-12" style="height: 20px;">
                    </div>
                    <label class="col-md-9 control-label" style="text-align: right;" >
                        Total Amount PKR</label>
                    <div class="col-lg-3" >
                        <input type="text" id="txtTotAmount" class="form-control" disabled="disabled" style="width: 100%;"
                            value="0" /></div>
                     <div class="col-md-12" style="height:20px;"></div>
                                <label class="col-md-9 control-label" style="text-align:right; display:none;">Total Amount RMB</label>
                    <div class="col-lg-3" style="display:none"; >
                        <input type="text" id="txtTotAmountRMB" class="form-control" disabled="disabled"
                            style="width: 100%;" value="0" /></div>
                    <div class="col-md-12" style="height: 20px;">
                    </div>
                    <div class="row">
                        <label class="col-md-10 control-label" style="text-align: right">
                            Discount</label>
                        <div class="col-lg-2">
                            <input type="text" id="txtDiscount" onkeyup="totPaste();" value="0" class="form-control"
                                style="width: 100%;" value="0" /></div>
                    </div>
                    <div class="row">
                        <label class="col-md-10 control-label" style="text-align: right; display:none;">
                            Tax Rate</label>
                        <div class="col-lg-2" style="display:none;">
                            <input type="text" id="txtTaxRate" value="0" onkeyup="totPaste();" class="form-control"
                                style="width: 100%;" value="0" /></div>
                    </div>
                    <div class="row">
                        <label class="col-md-10 control-label" style="text-align: right; display:none;">
                            Total Tax</label>
                        <div class="col-lg-2" style="display:none;">
                            <input type="text" id="txtTotTax" disabled="disabled" class="form-control" style="width: 100%;"
                                value="0" /></div>
                    </div>
                    <div class="row">
                        <label class="col-md-10 control-label" style="text-align: right">
                            Grand Total</label>
                        <div class="col-lg-2">
                            <input type="text" id="txtGrandTotal" disabled="disabled" class="form-control" style="width: 100%;"
                                value="0" /></div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 table-responsive">
                            <table id="Table1" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 8%">
                                        <span id="spnTotDb" style="font-weight: bold"></span>
                                    </td>
                                    <td style="width: 8%">
                                        <span id="spnTotCr" style="font-weight: bold"></span>
                                    </td>
                                    <td style="width: 8%">
                                    </td>
                                    <td style="width: 10%">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="button" id="btnSave" style="font-weight: bold; font-size: 20px;" class="btn btn-info btn-block"
                                value="P R O C E S S &nbsp&nbsp&nbsp P U R C H A S E  &nbsp&nbsp&nbsp O R D E R"
    ...
    <script type="text/javascript">
        ...
        function totPaste() {
            ...
            var totAmount = tot - parseFloat(tot) * parseFloat(txtDiscount) / 100   ;
           ...
           // document.getElementById("txtGrandTotal").value = parseFloat(totAmount);
        }
        ...
        function addRow() {
          ...
          //  $("#txtAccCode1").attr('idtwo', accID);
            ...
            ddlUnit.append('<option value="1">One</option>');
            ddlUnit.id = "ddlUnit" + newID;
            ddlUnit.className = 'form-control';
            ddlUnit.style.width = '100%';
            ddlUnit.style.border = '0px none';
            ddlUnit.onkeyup = function () {
                LoadDetailPrice(this)
            };
           
//            <select onchange='LoadDetailPrice(this)' id='ddlUnit' class='form-control' style='width: 100%;
//                                            border: 0px none;'>
//                                            <option value='0-0'>Select Unit</option>
//                                            <option value='Carton'>Carton</option>
//                                            <option value='Box'>Box</option>
...
//                                        </select>
            ...
            var cellDate = row.insertCell(5); //txtPrice
            var txtEDate = document.createElement("input");
            txtEDate.type = "date";
            txtEDate.id = "txtEDate" + newID;
            txtEDate.className = 'form-control';
            txtEDate.style.width = '100%';
            txtEDate.style.border = '0px none';
            //  txtEDate.value = '6';
            txtEDate.onkeyup = function () { // Note this is a function
                DatePick(this)
            };
            cellDate.appendChild(txtEDate);
            ...
            //document.getElementById("txtRMBPrice" + newID).style.display = "none";
            cell7.style.display = "none";

            var cell7Pack = row.insertCell(7); //txtRMBPackingPrice
            ...
            //document.getElementById("txtRMBPacking" + newID).style.display = "none";
            cell7Pack.style.display = "none";

            var cell77Carry = row.insertCell(8); //txtCarry
            ...
            cell77Carry.appendChild(txtCarry);
            cell77Carry.style.display = "none";
            //        var datePick = function DatePick() {
            //            $("#datepicker").datepicker();
            //            $("#datepicker").on("change", function () {
            //                var selected = $(this).val();
            ...
            var cell87 = row.insertCell(9); //txtExCharge
            ...
            //        txtExCharge.style.display = 'none';
            txtExCharge.value = '0';
            ...
            var cell8rmbcost = row.insertCell(10); //txtCostRMB1
            ...
            //document.getElementById("txtCostRMB" + newID).style.display = "none";
            cell8rmbcost.style.display = "none";

            var cell8pkrcost = row.insertCell(11); //txtCostPKR1
            ...
            cell8pkrcost.appendChild(txtCostPKR1);
            cell8pkrcost.style.display = 'none';


            var cell8 = row.insertCell(12); //txtTotalPrice
            ...
            //        var cell8 = row.insertCell(9); //txtTotalPrice
            //        var txtTotalPrice = document.createElement("input");
            //        txtTotalPrice.type = "text";
            //        txtTotalPrice.id = "txtTotalPrice" + newID;
            //        txtTotalPrice.className = 'form-control';
            ...
            var cell9 = row.insertCell(13); //txtTotalPrice
            ...
            //document.getElementById("txtRMBTotalPrice" + newID).style.display = "none";



            var cell100 = row.insertCell(14); //Delete
        ...
        function LoadDetailPrice(a) {
            ...
            var rateid = id.replace('ddlUnit', 'txtPrice');
            // alert(rateid);
            document.getElementById(rateid).value = splt[1];
            //  alert(splt[1]);
...
//            alert(itemID);
//          //  var itemID = $("#txtAccCode1").attr("idtwo");
//            var data = JSON.stringify({ itemID: itemID, name: a });
//            $.ajax({
//                url: "PO.aspx/UNIT_PRICE",
//                data: data,
//                type: "POST",
//                dataType: 'json',
//                contentType: 'application/json; charset=utf-8',
...
//            });
        ...
        //    alert(txtAccCodeID);
         ...
         //   alert(txtAccCode);
            ...
            var pp = document.getElementById("dvUnits").innerHTML;
            //alert(pp);
          //  var select = ddlUnit;
            var length = pp;
            ...
            for (var j = 0; j < row.length; j++) {
                ...
                //alert(row[j]);
                var pList = row[j].split('~');
                for (var i = 0; i < pList.length; i++) {
                    var myarr = pList[i];
                   // alert(myarr);
                    var arraycontainsturtles = (myarr.indexOf(itmID) > -1);
                    //alert(arraycontainsturtles);
                    if (arraycontainsturtles == true) {
                       ...
                       // alert(pItems[0]);
                        //alert(pItems[1]);
                        ddlUnit.appendChild(new Option(pItems[0],  pItems[0] + '-' + pItems[1]));
                    }
                    else {
                        //    alert("A");
                    }
        ...
        function tot(a) {
            ...
            if (document.getElementById("ddlPurchaseType").value == "PKR") {
                ...
                PKRUNITPRICE = PKRUNITPRICE.toFixed(2);
        ...
        function SaveTransaction() {
            ...
            for (var i = 0; i < elms.length; i++) {
                if (elms[i].id.indexOf('txtAccCode') != -1) {
                    ...
                    var txtEDateID = iD.replace('txtAccCode', 'txtEDate');
                    //   alert(txtEDateID);
                    ...
                    var txtEDate = document.getElementById(txtEDateID).value;
                    var txtddlUnitID = iD.replace('txtAccCode', 'ddlUnit');

                    var txtPriceRMB = "1";
                    var txtTotalPriceRMB = "1";
                    var txtRMBValue = "1";
                    ...
                    var txtRMBCOST = "1";
                    //Changes in '' in txtPackingRate
                    var txtPackingRate = "1";

                    var txtPackingPrice = "1";
                    // var txtPackingPrice = '1';

                    var txtPackingPricePKR = "1";
                  ...
                  //  alert(unitname);
                    ...
                    if (txtQty != 0) {
                        if (cc == 0) {
                            str = txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate + "^" + unitname;
                        }
                        else {
                            str = str + "`" + txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate + "^" + unitname;
                        }
                    }
            ...
            if (cc > 0) {
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        window.open('../REPORTS/PO_His.aspx?ID=' + tblRows + '&Type=Detail&BID=' + BranchID, '_blank');
                        location.reload();
                    }
