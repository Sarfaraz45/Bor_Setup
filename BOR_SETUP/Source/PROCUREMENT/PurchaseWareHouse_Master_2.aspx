<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PurchaseWareHouse_Master_2.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Transfer Order IN ( USER ) </h3>
...
<script type="text/javascript">
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_2.aspx/LOAD_ITEMS',
            data: '{ "UserID" : "' + UserID + '" }',
    ...
    function SaveTransaction() {
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'PurchaseWareHouse_Master_2.aspx/SaveTransaction',
                //data: {},
