<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="SO_Cash.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Cash Sale </h3>
                            ...
                            <div class="col-lg-4">
                                ...
                                <asp:DropDownList ID="ddlSupplier" runat="server" DataSourceID="SqlDataSource1"  CssClass="chzn-select form-control" 
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                            ...
                                            SelectCommand="SELECT AccountsID, AccountsTitle + ' ( ' +   convert(nvarchar(20),Round(Balance,2)) + ' ) ' AS AccountsTitle FROM [VW_ACCOUNTS_NAME_WITH_BALANCE]  where BranchID1=@BranchID">
                                            <SelectParameters>
  ...
  <div class="col-lg-4">
                         ...
                         <div class="row"><div class="col-lg-12" style="height:10px"></div></div>
                                    ...
                                    <table id="tblItems" class="table table-striped table-bordered dataTable no-footer">
                                        ...
                                        <tr>
                                            ...
                                            <td>                                             
                                             ...
                                             data-items="10" autocomplete="off" >
                                            </td>                   
                                            <%--<td>
                                            ...
                                            <td><input type="text"  autocomplete="off" id="txtDescription1" class="form-control" style="width:100%; border:0px none;" /></td>
                                            <td><input type="text"  autocomplete="off" id="txtQty1" class="form-control" value="1" style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                                            <%--<td><input type="text" id="txtRMBValue1" class="form-control" value="" disabled="disabled"  style="width:100%; border:0px none;" /></td>--%>
                                            <td><input type="text"  autocomplete="off" id="txtPrice1" class="form-control" value="0"  style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                          ...
                          <label class="col-md-3 control-label" style="text-align:right">Received Account</label>
                                <div class="col-lg-3">
                                 <asp:DropDownList ID="ddlRcvdAccount" runat="server" DataSourceID="SqlDataSource2"  CssClass="chzn-select form-control" 
                                            DataTextField="AccountsTitle" DataValueField="AccountsID">
                                </asp:DropDownList>
                                </div>
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        var cell444 = row.insertCell(2); //txtQty
        var txtDescription = document.createElement("input");
        txtDescription.type = "text";
        txtDescription.id = "txtDescription" + newID;
        txtDescription.className = 'form-control';
        txtDescription.style.width = '100%';
        cell444.appendChild(txtDescription); //SumDbCr();
        document.getElementById("txtDescription" + newID).setAttribute("autocomplete", "off");
        ...
        document.getElementById("txtQty" + newID).setAttribute("autocomplete", "off");

        var cell6 = row.insertCell(4); //txtPrice
        ...
        document.getElementById("txtPrice" + newID).setAttribute("autocomplete", "off");

        var cell7 = row.insertCell(5); //txtTotalPrice
        ...
        var cell8 = row.insertCell(6); //txtTotalPrice
        ...
        var cell9 = row.insertCell(7); //txtTotalPrice
        ...
        var cell100 = row.insertCell(8); //Delete
        ...
        var cell10 = row.insertCell(9); //txtValidateQty
    ...
    function SaveTransaction() {
        ...
        for (var i = 0; i < elms.length; i++) {
            if (elms[i].id.indexOf('txtAccCode') != -1) {
                ...
                if (txtQty != 0) {
                    if (cc == 0) {
                        str = txtAccID + "^" + txtAccTitle + "^" + ddlUnit + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + PRID + "^" + PRDID + "^" + txtSrNo + "^" + txtDescription;
                    }
                    else {
                        str = str + "`" + txtAccID + "^" + txtAccTitle + "^" + ddlUnit + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + PRID + "^" + PRDID + "^" + txtSrNo + "^" + txtDescription;
                    }
                }
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'SO_Cash.aspx/SaveTransaction',
                //data: {},
                data: '{ "UserID" : "' + UserID + '", "str" : "' + str + '", "txtVDate" : "' + txtVDate + '", "txtVoucherNo" : "' + txtVoucherNo +
                '", "txtTotAmount" : "' + txtTotAmount + '", "txtDiscount" : "' + txtDiscount + '", "txtTaxRate" : "' + txtTaxRate + '", "txtTotTax" : "' + txtTotTax + '", "txtGrandTotal" : "' + txtGrandTotal + '", "ddlSupplier" : "' + ddlSupplier + '", "txtTotAmountRMB" : "' + txtTotAmountRMB + '", "RMBValueHDN" : "' + RMBValueHDN + '", "txtDiscountPKR" : "' + txtDiscountPKR + '", "txtDiscountRMB" : "' + txtDiscountRMB + '", "txtCusAmountPKR" : "' + txtCusAmountPKR + '", "txtCusAmountRMB" : "' + txtCusAmountRMB + '", "ddlShop" : "' + ddlShop + '", "txtCustomerName" : "' + txtCustomerName + '", "txtContactNo" : "' + txtContactNo + '", "txtAddress" : "' + txtAddress + '", "txtBillNo" : "' + txtBillNo + '", "RcvdAccount" : "' + RcvdAccount + '", "RcvdPKR" : "' + RcvdPKR + '", "RcvdRMB" : "' + RcvdRMB + '", "BranchID" : "' + BranchID + '", "txtCashBack" : "' + txtCashBack + '","txtCashRcvd" : "' + txtCashRcvd + '","X5000" : "' + X5000 + '", "X1000" : "' + X1000 + '", "X500" : "' + X500 + '", "X100" : "' + X100 + '", "X50" : "' + X50 + '","X20" : "' + X20 + '", "X10" : "' + X10 + '", "X5" : "' + X5 + '", "X2" : "' + X2 + '", "X1" : "' + X1 + '"}',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                success: function (msg) {
                    tblRows = msg.d;
                    alert('CASH SO has been Generated Successfully!');
