<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="SaleWareHouse_Master.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Transfer Order OUT ( MASTER )</h3>
...
//        }
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'SaleWareHouse_Master.aspx/LOAD_ITEMS',
            data: '{ "UserID" : "' + UserID + '" }',
    ...
    function SaveTransaction() {
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'SaleWareHouse_Master.aspx/SaveTransaction',
                //data: {},
