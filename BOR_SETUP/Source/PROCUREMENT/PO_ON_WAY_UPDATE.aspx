<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PO_ON_WAY_UPDATE.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<div class="modal fade" id="HistoryModal">
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Update Purchase Order ( ON WAY ) </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <asp:DropDownList ID="ddlPendingOnway" runat="server" DataSourceID="SqlDataSource2"  CssClass="chzn-select form-control"
                                    ...
                                    <div class="col-md-2">
                                    <input type="button" class="btn btn-block btn-info" value="GET DATA" onclick="GetOnWayData();" />
                                    </div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" id="txtONWAYID" placeholder="ON WAY UPDATE ID" class="form-control" disabled="disabled" />
                          ...
                          <div class="col-lg-4">
                             ...
                             <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="txtContainerNo" value="0" class="form-control" />                               
                        ...
                        <div class="row">
                         ...
                         <div class="row"><div class="col-lg-12" style="height:10px"></div></div>
                            ...
                            <%-- <input type="button" id="btnClear" class="btn btn-danger btn-sm" value="Clear Form" onclick="ClearForm();" />--%>
                             <input type="button" id="btnSave" style="font-weight:bold; font-size:20px;" class="btn btn-success btn-block" value="U P D A T E" onclick="SaveTransaction();" />
                             </div></div>
...
<script type="text/javascript">
    ...
    function GetOnWayHistory() {
        ...
        $.ajax({
            ...
            url: "PO_ON_WAY_UPDATE.aspx/LoadOnwayHistory",
            dataType: "json",
            //data: "{}",
            data: dataToSend,
            async: false,
    ...
    function GetOnWayData() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "PO_ON_WAY_UPDATE.aspx/LoadOnway",
            dataType: "json",
            //data: "{}",
            data: dataToSend,
            async: false,
    ...
    function GetRate() {
        ...
        $.ajax({
            type: "POST",
            url: "PO_ON_WAY_UPDATE.aspx/LoadType",
            //data: {},
    ...
    var BranchID = localStorage.getItem("BranchID");
        ...
        $.ajax({
            type: "POST",
            url: "PO_ON_WAY_UPDATE.aspx/LoadRMbValue",
            data: dataToSend,            
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
...
//        cell5.appendChild(txtRMBValue); //SumDbCr();
    ...
    var BranchID = localStorage.getItem("BranchID");
        ...
        $.ajax({
            type: 'POST',
            url: 'PO_ON_WAY_UPDATE.aspx/LOAD_ITEMS',
