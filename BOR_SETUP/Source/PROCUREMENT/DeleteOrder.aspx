<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="DeleteOrder.aspx.cs" Inherits="PROCUREMENT_PO_LIST" %>
...
<script type="text/javascript">
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'DeleteOrder.aspx/LOAD_ITEMS',
    ...
    function Delete(id) {
        ...
        var results = $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "DeleteOrder.aspx/DeleteRegion",
            dataType: "json",
            data: dataToSend,
            async: false,
