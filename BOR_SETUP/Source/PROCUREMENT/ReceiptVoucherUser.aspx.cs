...
public partial class PROCUREMENT_PO : System.Web.UI.Page
{
    ...
    public static string LOAD_ACCOUNTS(string UserID, string BranchID)
    {
        ...
        string query = "SELECT AccountsID, AccountsTitle + ' ^ ' + convert(Nvarchar(20), AccountsID) AS AccountsTitle FROM [VW_ACCOUNTS_NAME_WITH_BALANCE] where BranchID1='" + BranchID + "'";
    ...
    public static string SaveTransaction(string UserID, string txtVDate, string ddlType, string RMBValue, string str, string ddlCurrency, string BranchID)
    {
        ...
        if (ddlType== "PVD")
        {
            ...
            for (int i = 0; i < itmLST.Length; i++)
            {
                ...
                SqlCommand cmdPurchase2 = new SqlCommand("insert into Transaction_Detail (Date,AccountID,TransactionType,DebitPKR,DebitRMB,CreditPKR,CreditRMB,RMBValue,TaskID,Narration,CreateBy, BranchID) values ('" + txtVDate + "','" + FrmAccID + "','PVD','0','0','" + Amount + "','" + Rmb + "','" + RMBValue + "','" + txtVoucherNo + "','" + Narration + "','" + UserID + "','" + BranchID + "')", Con);
                Con.Open();
                cmdPurchase2.ExecuteNonQuery();
                Con.Close();

                SqlCommand cmdPurchase1 = new SqlCommand("insert into Transaction_Detail (Date,AccountID,TransactionType,DebitPKR,DebitRMB,CreditPKR,CreditRMB,RMBValue,TaskID,Narration,CreateBy, BranchID) values ('" + txtVDate + "','" + ToAccID + "','PVD','" + Amount + "','" + Rmb + "','0','0','" + RMBValue + "','" + txtVoucherNo + "','" + Narration + "','" + UserID + "','" + BranchID + "')", Con);
                Con.Open();
        ...
        else
        {
            ...
            for (int i = 0; i < itmLST.Length; i++)
            {
                ...
                SqlCommand cmdPurchase2 = new SqlCommand("insert into Transaction_Detail (Date,AccountID,TransactionType,DebitPKR,DebitRMB,CreditPKR,CreditRMB,RMBValue,TaskID,Narration,CreateBy, BranchID) values ('" + txtVDate + "','" + ToAccID + "','PVC','" + Amount + "','" + Rmb + "','0','0','" + RMBValue + "','" + txtVoucherNo + "','" + NarrationTo + "','" + UserID + "','" + BranchID + "')", Con);
                Con.Open();
                cmdPurchase2.ExecuteNonQuery();
                Con.Close();

                SqlCommand cmdPurchase1 = new SqlCommand("insert into Transaction_Detail (Date,AccountID,TransactionType,DebitPKR,DebitRMB,CreditPKR,CreditRMB,RMBValue,TaskID,Narration,CreateBy, BranchID) values ('" + txtVDate + "','" + FrmAccID + "','PVC','0','0','" + Amount + "','" + Rmb + "','" + RMBValue + "','" + txtVoucherNo + "','" + NarrationFrom + "','" + UserID + "','" + BranchID + "')", Con);
                Con.Open();
                cmdPurchase1.ExecuteNonQuery();
                Con.Close();
            }
