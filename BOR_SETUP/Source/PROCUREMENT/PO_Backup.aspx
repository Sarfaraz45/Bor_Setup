            ...
            if (elms[i].id.indexOf('txtAccCode') != -1) {
             ...
             // alert("A");
              ...
              //  alert(txtPackingPricePKR);
                ...
                if (txtQty != 0) {
                    if (cc == 0) {
                        str = txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate;
                    }
                    else {
                        str = str + "`" + txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate;
                    }
                }
