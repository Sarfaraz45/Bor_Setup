       ...
       // rqHID = LoadHistoryID(rqID);
        ...
        for (int i = 0; i < itmLST.Length; i++)
        {
            ...
            string txtSrNo = itmROW[15].ToString();
             ...
             string ddlUnit = itmROW[17].ToString();
            ...
            SqlParameter ddlUnit_P = new SqlParameter("@ddlUnit", ddlUnit);
            ...
            AACommon.Execute("SP_DETAIL_INSERT", Con, SPID_1, ITEMID, UnitID, EDATE,ddlUnit_P, QtyIn, UnitPrice, TotalPrice, RMBValue, RMBUnitPrice, RMBTotalPrice, Type, Carry, ExtraCharges, BasicUnitPricePKR, BasicUnitPriceRMB, RMBPackingRate, RMBPackingPrice, PKRPackingPrice, SRNO, CreateByNew, BranchP);
