<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="SO_Edit.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title" style="color:White;"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Sale Order EDIT</h3>
                                ...
                                <div class="col-lg-12 table-responsive" id="NewDiv">
                                    <table id="tblItems" class="table table-striped table-bordered dataTable no-footer" >
                                        <tr>
                                           ...
                                           <th style="width:11%">PKR Price</th>                                                                                   
                                            <th style="width:11%">RMB Price </th>                                            
                                            <th style="width:11%">Total (PKR)</th>
...
//        cell5.appendChild(txtRMBValue); //SumDbCr();
    ...
    function LoadPurchaseData() {
        ...
        var tblRows = "";
        var UserID = "1";
        var tbl = "<table id='tblItems' class='table table-striped table-bordered dataTable no-footer' style='overflow:visible;'><tbody><tr><th style='width:5%'>Sr.</th><th style='width:30%'>Item</th><th style='width:12%'>Description</th><th style='width:7%'>Qty.</th><th style='width:11%'>PKR Price</th><th style='width:11%'>RMB Price</th><th style='width:11%'>Total Price (PKR)</th><th style='width:11%'>Total Price (RMB)</th><th style='width:2%'></th></tr>";
        var cc = 0;
        var ccValue = 0;
        $.ajax({
            type: 'POST',
            url: 'SO_Edit.aspx/LOAD_PURCHASE',
...
//        }
        ...
        if (cc > 0) {
            $.ajax({
                type: 'POST',
                url: 'SO_Edit.aspx/SaveTransaction',
                //data: {},
