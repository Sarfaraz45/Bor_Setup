<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="SO.aspx.cs" Inherits="PROCUREMENT_PO" %>
                                    ...
                                    <table id="tblItems" class="table table-striped table-bordered dataTable no-footer">
                                        ...
                                        <tr>
                                           ...
                                           <%-- <td>
                                            ...
                                            <td><input type="text"  autocomplete="off" id="txtDescription1" class="form-control" style="width:100%; border:0px none;" />
                                        </td>
