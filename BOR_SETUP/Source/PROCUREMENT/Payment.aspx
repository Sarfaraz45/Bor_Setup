<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="Payment.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<script type="text/javascript">
    ...
    function LOAD_ACCOUNTS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'Payment.aspx/LOAD_ACCOUNTS',
    ...
    function SaveTransaction() {
        ...
        var BranchID = localStorage.getItem("BranchID");        
            $.ajax({
                type: 'POST',
                url: 'Payment.aspx/SaveTransaction',
                //data: {},
