...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  ...
  <%--  <link href="../styles.css" rel="stylesheet" type="text/css" />--%>
    ...
    <script type="text/javascript">
        ...
        function AddData(a, name, carton, loose, strip, box) {
            //  alert(a);
        ...
        function AddDataHold(a, name, carton, loose, strip, box, qty) {
            //  alert(a);
        ...
        function AddDataHold_old(a, name, rate, title, qty, unittypeid) {
            //  alert(rate);
...
//        }
        ...
        function LoadDetailPrice(a) {
         ...
         //  alert(val);
            var splt = val.split('-');
//            var spltArr = splt.split(',');
            //            alert(spltArr);
          //  alert(splt);
            var rateid = id.replace('ddlUnit', 'rt');
           // alert(rateid);
...
//                    alert(txtddlUnit);
                    ...
                    if (txtQty != 0) {
                        if (cc == 0) {
                            str = itmid + "^" + txtQty + "^" + txtRate + "^" + txtTotalPrice + "^" + unitname;
                        }
                        else {
                            str = str + "`" + itmid + "^" + txtQty + "^" + txtRate + "^" + txtTotalPrice + "^" + unitname;
                        }
                    }
                    cc = 1;
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                        ...
                        AddDataHold(value.ITEMID, value.ITEMName, value.CartonPrice, value.LoosePrice, value.StripPrice, value.BoxPrice, value.QtyOut);
                    });
...
//                        //   alert(value.ITEMID);
//                        // rows += "<option  value=" + value.ITEMID + ">" + value.ITEMName + "</option>";
//                        //AddData(value.ITEMID, value.ITEMName, value.Price);
//                        AddData(value.ITEMID, value.ITEMName,value.Price);
//                    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                        ...
                        AddData(value.ITEMID, value.ITEMName, value.CartonPrice, value.LoosePrice, value.StripPrice, value.BoxPrice);
                    });
...
//                        // rows += "<option  value=" + value.ITEMID + ">" + value.ITEMName + "</option>";
//                        //AddData(value.ITEMID, value.ITEMName, value.Price);
//                        AddData(value.ITEMID,value.Price);
//                    });
        ...
        function LoadRegion() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                        ro += "<tr><td class='two'>" + value.ITEMName + "</td><td class='two'><input type='button' data-dismiss='modal' class='btn btn-block btn-info  ' onclick='LoadRegionTwo(\"" + value.SPID + "\");' value ='Retrive'> </td><td class='two'><input type='button'  class='btn btn-block btn-danger  ' data-dismiss='modal' onclick='DeleteRegion(\"" + value.SPID + "\");' value ='Delete'> </td></tr>";
           ...
           alert(BranchID);
            $.ajax({
                ...
                success: function (data) {
                    ...
                    ro = "<table id='tablepaging' class='table ' style='cursor: pointer;' ><thead><th>Description</th><th>Action</th></thead><tbody>";
                    $.each(jsdata, function (key, value) {
                        ro += "<tr><td class='two'>" + value.ITEMName + "</td></tr>";
