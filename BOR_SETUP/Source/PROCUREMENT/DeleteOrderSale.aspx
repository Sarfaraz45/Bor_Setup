<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="DeleteOrderSale.aspx.cs" Inherits="PROCUREMENT_PO_LIST" %>
...
<!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> DELETE SALE </h3>
...
<!-- vd_panel-menu --> 
                        ...
                        <div class="panel-body">   
                            <div class="col-md-12">
                             <input type="text" class="span6 typeahead form-control" placeholder="SEARCH BY INVOICE NUMBER,DATE AND CUSTOMER NAME."  onblur="javascript:LoadLIST(this);"  style="overflow:visible;" id="txtAccCode1"  data-provide="typeahead" style="width:100%" 
                                             data-items="10" >
                             </div>
...
<script type="text/javascript">
    ...
    function LoadLIST(a) {
        ...
        var res = txtAccCode.substring(11, 28);        
        var PaymentType = res;        
        var tblRows = "";
        ...
        $.ajax({
            type: 'POST',
            url: 'DeleteOrderSale.aspx/LoadLIST',
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'DeleteOrderSale.aspx/LOAD_ITEMS',
    ...
    function Delete(id) {        
        ...
        var results = $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "DeleteOrderSale.aspx/DeleteRegion",
            dataType: "json",
            data: dataToSend,
            async: false,
