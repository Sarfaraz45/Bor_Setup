<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="ReceiptVoucher.aspx.cs" Inherits="PROCUREMENT_PO" %>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="col-md-6 control-label" style="margin-top:5px;">Date :</label>
                
                                               <label class="col-md-6 control-label" style="margin-top:5px;">Type :</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ReceiptVoucher.aspx/LoadRMbValue",
            data: dataToSend,
            dataType: "json",
    ...
    function LOAD_ACCOUNTS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'ReceiptVoucher.aspx/LOAD_ACCOUNTS',
    ...
    function GetVoucherNo() {
        ...
        $.ajax({
            type: "POST",
            url: "ReceiptVoucher.aspx/LoadNUMBER",
    ...
    function SaveTransaction() {
        ...
        var BranchID = localStorage.getItem("BranchID");
            $.ajax({
                type: 'POST',
                url: 'ReceiptVoucher.aspx/SaveTransaction',
                //data: {},
