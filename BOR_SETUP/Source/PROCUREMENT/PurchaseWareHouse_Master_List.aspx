<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PurchaseWareHouse_Master_List.aspx.cs" Inherits="PROCUREMENT_PO_LIST" %>
...
<!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Transfer Order IN LIST</h3>
...
<!-- vd_panel-menu --> 
                ...
                <div class="row">
                                ...
                                <asp:HyperLink ID="HyperLink2" NavigateUrl="~/PROCUREMENT/PurchaseWareHouse_Master.aspx" runat="server">Add New Transfer Master IN</asp:HyperLink>
                                </div>
...
<script type="text/javascript">
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List.aspx/LOAD_ITEMS',
            data: '{ "UserID" : "' + UserID + '" }',
    ...
    function LoadLIST() {
       ...
       // alert('ddddddddd');
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List.aspx/LoadLIST',
            data: '{ "UserID" : "' + UserID + '" }',
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            success: function (msg) {
    ...
    function LoadLISTSearch(a) {        
        ...
        $.ajax({
            type: 'POST',
            url: 'PurchaseWareHouse_Master_List.aspx/LoadLISTSearch',
