<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PaymentVoucher.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "PaymentVoucher.aspx/LoadRMbValue",
            data: dataToSend,
            dataType: "json",
    ...
    function LOAD_ACCOUNTS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PaymentVoucher.aspx/LOAD_ACCOUNTS',
    ...
    function GetVoucherNo() {
        ...
        $.ajax({
            type: "POST",
            url: "PaymentVoucher.aspx/LoadNUMBER",
    ...
    function SaveTransaction() {
        ...
        var BranchID = localStorage.getItem("BranchID");        
            $.ajax({
                type: 'POST',
                url: 'PaymentVoucher.aspx/SaveTransaction',
                //data: {},
