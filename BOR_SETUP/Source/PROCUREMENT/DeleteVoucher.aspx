<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="DeleteVoucher.aspx.cs" Inherits="PROCUREMENT_PO_LIST" %>
...
<!-- ================== BEGIN PAGE LEVEL STYLE ================== -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> DELETE VOUCHER</h3>
...
<!-- vd_panel-menu --> 
                        ...
                        <div class="col-md-12">
                             <input type="text" class="span6 typeahead form-control" placeholder="SEARCH BY VOUCHER NUMBER, DATE AND AMOUNT."  onblur="javascript:LoadLIST(this);"  style="overflow:visible;" id="txtAccCode1"  data-provide="typeahead" style="width:100%" 
                                             data-items="10" >
                             </div>
                             <%--<div class="row">
                              <div class="col-md-12">
                             <select id="ddlType" onchange="LoadLIST();" runat="server"  class="form-control" ></select>
                ...
                <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-danger col-md-12 col-sm-12 col-xs-12" id="btnSave" style="font-weight:bold; font-size:20px;"    onclick="Delete();">D E L E T E</button>
                            </div></div>
                                            </div></div></div></div>
...
<script type="text/javascript">
    ...
    function LoadLIST(a) {
        ...
        $.ajax({
            type: 'POST',
            url: 'DeleteVoucher.aspx/LoadLIST',
    ...
    function LOAD_ITEMS() {
        ...
        $.ajax({
            type: 'POST',
            url: 'DeleteVoucher.aspx/LOAD_ITEMS',
    ...
    function Delete() {        
        var txtAccCode = document.getElementById("txtAccCode1").value;
        var res = txtAccCode.substring(13, 31);        
        //        var id = document.getElementById("ContentPlaceHolder1_ddlType").value;
        var id = res;
        ...
        var results = $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "DeleteVoucher.aspx/DeleteRegion",
            dataType: "json",
            data: dataToSend,
            async: false,
