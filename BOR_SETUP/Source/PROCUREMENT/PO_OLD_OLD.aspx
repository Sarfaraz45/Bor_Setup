<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="PO_oldd.aspx.cs" Inherits="PROCUREMENT_PO" %>
...
<!-- #modal-message -->
  ...
  <div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Purchase Order ( IMPORT ) </h3>
                        ...
                        <div class="row">
                          <div class="col-lg-4" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                <asp:DropDownList ID="ddlPackingAccount" runat="server" DataSourceID="SqlDataSource1"  CssClass="chzn-select form-control"
                                            DataTextField="AccountsTitle" DataValueField="AccountsID">
                                </asp:DropDownList>
...
<%--   <th style="width:6%">Cost </th>  --%>
                                        ...
                                        <tr>
                                            ...
                                            <td>                                             
                                             ...
                                             data-items="10" >
                                                ...
                                                <td>
                                            <select  onchange='LoadDetailPrice(this)' id="ddlUnit" class="form-control"  style="width:100%; border:0px none;">
                                      ...
                                      <td><input type="date" id="txtEDate1" class="form-control"     style="width:100%; border:0px none;"/></td>
                                           
                                           
                                          

                                            <td style="display:none;"><input type="text" id="txtCarry1" class="form-control" value="0"    style="width:100%; border:0px none; display:none;" onkeyup="tot(this);"/></td>
                                           
                                               


                                            <td style="display:none;"><input type="text" id="txtExCharge1" class="form-control" value="0"    style="width:100%; border:0px none;" onkeyup="tot(this);"/></td>
                                             
                                           

                                            <td style="display:none;"><input type="text" id="txtCostPKR1" class="form-control" value="00" disabled="disabled"  style="width:100%; border:0px none; " /></td>
                                            <td style="display:none;"><input type="text" id="txtCostRMB1" class="form-control" value="0" disabled="disabled"  style="width:100%; border:0px none;" /></td>
                                          
                                            <td ><input type="text" id="txtTotalPrice1" class="form-control" value="2" disabled="disabled"  style="width:100%; border:0px none;" /></td>
                            ...
                            <div class="row" style="height:20px;"></div>
                                <label style="display:none" class="col-md-6 control-label" >Carry Amount</label>
                                <label  style="display:none" class="col-md-4 control-label" >Packing Amount </label>
                                <label style="display:none" class="col-md-6 control-label" >Ex. Charges Amount </label>
                                
                                
                                <div class="col-lg-6" style="display:none" ><input type="text" id="txtCarryPKR" class="form-control" disabled="disabled" style="width:100%;" value="0" /></div>
                                <div class="col-lg-4" ><input type="text" id="txtPackingPKR" class="form-control" disabled="disabled" style="width:100%; display:none"  value="0" /></div>
                                <div class="col-lg-6" style="display:none"><input type="text" id="txtExChrgPKR" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
                           ...
                           <%-- <label class="col-md-4 control-label" >Carry Amount RMB</label>
                                ...
                                <div class="col-lg-4" style="display:none;"><input type="text" id="txtCarryRMB" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
                                <div class="col-lg-4" style="display:none;"><input type="text" id="txtPackingRMB" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
                                <div class="col-lg-4" style="display:none;"><input type="text" id="txtExChrgRMB" class="form-control" disabled="disabled" style="width:100%;"  value="0" /></div>
...
//                var ddlUnitID = 333;
               // alert(ddlUnit);
               // var txtddlUnit = document.getElementById('ddlUnitID').value;
                //alert(txtddlUnit);
...
//                alert(ddlUnit);
                ...
                if (txtQty != 0) {
                    if (cc == 0) {
                        str = txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate + "^" + ddlUnit;
                    }
                    else {
                        str = str + "`" + txtAccID + "^" + txtAccTitle + "^" + txtQty + "^" + txtPrice + "^" + txtTotalPrice + "^" + txtPriceRMB + "^" + txtTotalPriceRMB + "^" + txtRMBValue + "^" + txtCarry + "^" + txtExCharge + "^" + txtPKRCOST + "^" + txtRMBCOST + "^" + txtPackingRate + "^" + txtPackingPrice + "^" + txtPackingPricePKR + "^" + txtSrNo + "^" + txtEDate + "^" + ddlUnit;
                    }
                }
