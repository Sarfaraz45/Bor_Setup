<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="UnitType.aspx.cs" Inherits="ERP_UnitType" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    ro = "<table id='tablepaging' class='table table-hover' style='cursor: pointer;' ><thead><th>ID</th><th>UnitType</th></thead><tbody>";
        ...
        function UpdateRegion() {
            ...
            var dataToSend = JSON.stringify({ 'UnitTypeID': $('#ContentPlaceHolder1_hdnid').val(), 'UnitTypeDesc': $('#txtunittype').val() });
            //alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function DeleteRegion() {
          //  alert($('#ContentPlaceHolder1_hdnid').val());
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'UnitTypeID': $('#ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
...
<div class="row"  id="dvOrderList">
			    ...
			    <div class="col-md-12" >
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Unit Type! </h3>
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtunittype" required="required" class="form-control col-md-7 col-xs-12" placeholder="Enter Unit Type">  
