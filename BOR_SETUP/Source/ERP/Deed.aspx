<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="Deed.aspx.cs" Inherits="ERP_Deed" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    ro = "<table id='tablepaging' class='table table-hover' style='cursor: pointer;' ><thead><th>ID</th><th>District Title</th></thead><tbody>";
                    $.each(jsdata, function (key, value) {
                        ro += "<tr><td width='35%'  class='one'>" + value.DeedID + "</td><td width='65%'  class='two'>" + value.DeedTitle + "</td></tr>";
        ...
        function InsertRegion() {
            ...
            var dataToSend = JSON.stringify({'DeedTitle': $('#txtunittype').val(), 'UserID': UserID });
           // alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Deed.aspx/InsertRegion",
                dataType: "json",
                data: dataToSend,
        ...
        function UpdateRegion() {
           ...
           var dataToSend = JSON.stringify({ 'DeedID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'DeedTitle': $('#txtunittype').val() });
            //alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Deed.aspx/UpdateRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
        ...
        function DeleteRegion() {
            //  alert($('#ContentPlaceHolder1_hdnid').val());
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'DeedID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Deed.aspx/DeleteRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Deed Type<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtunittype" required="required" class="form-control col-md-7 col-xs-12" placeholder="Enter Deed Type">  
