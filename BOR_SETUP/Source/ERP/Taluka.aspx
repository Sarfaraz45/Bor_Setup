<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="Taluka.aspx.cs" Inherits="ERP_Taluka" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                        ro += "<tr><td   class='one'>" + value.TalukaID + "</td><td  class='two'>" + value.TalukaTitle + "</td>   <td  style='display:none;' class='four'>" + value.DistrictID + "</td> </tr>";
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "Taluka.aspx/LoadRegionCombo1",
                data: {},
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                       // alert(value.DistrictTitle);
                        rows += "<option  value=" + value.DistrictID + ">" + value.DistrictTitle + "</option>";
                    });
        ...
        function InsertRegion() {
            ...
            var dataToSend = JSON.stringify({ 'TalukaTitle': $('#txttitle').val(), 'DistrictID': ddl, 'UserID': UserID });
           // alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Taluka.aspx/InsertRegion",
                dataType: "json",
                data: dataToSend,
        ...
        function UpdateRegion() {
            ...
            var dataToSend = JSON.stringify({ 'TalukaID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'TalukaTitle': $('#txttitle').val(), 'DistrictID': ddl });
            alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Taluka.aspx/UpdateRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
        ...
        function DeleteRegion() {
            //  alert($('#ContentPlaceHolder1_hdnid').val());
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'TalukaID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Taluka.aspx/DeleteRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
                  ...
                  <div class="panel-body">
                    <form class="form-horizontal" action="#" role="form">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Taluka</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" required="required" id="txttitle" class="form-control" placeholder="Taluka Title">
                        </div>
                      </div>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         ...
                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select District <span class="required"></span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                             <asp:DropDownList  ID="DropDownList" DataTextField="TalukaTitle" DataValueField="TalukaID" runat="server" CssClass="chzn-select form-control" DataSourceID="SqlDataSource1"></asp:DropDownList> 
