<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="ERP_UnitType" %>
    ...
    <script type="text/javascript">
        ...
        function InsertRegion() {
            ...
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Category.aspx/InsertRegion",
                dataType: "json",
                data: dataToSend,
        ...
        function UpdateRegion() {
            ...
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Category.aspx/UpdateRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
        ...
        function DeleteRegion() {
            ...
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Category.aspx/DeleteRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
...
<div class="row"  id="dvOrderList">
			    ...
			    <div class="col-md-6" >
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                    ...
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Category Information </h3>
...
<!-- vd_panel-menu --> 
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <div class="col-md-12">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Category TItle <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="txtunittype" required="required" class="form-control col-md-12 col-xs-12" placeholder="Enter Category Title">  
                   ...
                   <div class="panel widget light-widget panel-bd-top">
                        <div class="panel-heading bordered">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="icon-pie"></i> </span> Category List </h3>
                    <div class="vd_panel-menu">
  <div data-action="minimize" data-original-title="Minimize" data-toggle="tooltip" data-placement="bottom" class=" menu entypo-icon"> <i class="icon-minus3"></i> </div>
  <div data-action="refresh"  data-original-title="Refresh" data-toggle="tooltip" data-placement="bottom" class=" menu entypo-icon smaller-font"> <i class="icon-cycle"></i> </div>
