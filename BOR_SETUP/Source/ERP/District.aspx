<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="District.aspx.cs" Inherits="ERP_District" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(jsdata, function (key, value) {
                        ro += "<tr><td width='35%'  class='one'>" + value.DistrictID + "</td><td width='65%'  class='two'>" + value.DistrictTitle + "</td></tr>";
        ...
        function InsertRegion() {
            ...
            var dataToSend = JSON.stringify({'DistrictTitle': $('#txtunittype').val(), 'UserID': UserID });
           // alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "District.aspx/InsertRegion",
                dataType: "json",
                data: dataToSend,
        ...
        //   alert($('#ContentPlaceHolder1_hdnid').val());
           var dataToSend = JSON.stringify({ 'DistrictID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'DistrictTitle': $('#txtunittype').val() });
            //alert(dataToSend);
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "District.aspx/UpdateRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
        ...
        function DeleteRegion() {
            //  alert($('#ContentPlaceHolder1_hdnid').val());
            var UserID = localStorage.getItem("UserID");
            var dataToSend = JSON.stringify({ 'DistrictID': $('#ctl00_ContentPlaceHolder1_hdnid').val(), 'UserID': UserID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "District.aspx/DeleteRegion",
                dataType: "json",
                data: dataToSend,
                async: false,
                success: function (data) {
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txtunittype" required="required" class="form-control col-md-7 col-xs-12" placeholder="Type District Name">  
