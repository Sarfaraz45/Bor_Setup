<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Master.master" AutoEventWireup="true" CodeFile="UserTypeForms.aspx.cs" Inherits="Setup_UserTypeForms" %>
...
border-color: #d8dde1;
    ...
    <script type="text/javascript">
        ...
        function InsertRegion() {
            ...
            var form = $('#ContentPlaceHolder1_ddlForm').val();
            var BranchID = localStorage.getItem("BranchID");
            var dataToSend = JSON.stringify({ 'utid': ddl, 'form': form, 'UserID': UserID, 'BranchID': BranchID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function UpdateRegion() {
            ...
            var form = $('#ContentPlaceHolder1_ddlForm').val();
            var BranchID = localStorage.getItem("BranchID");            
            var dataToSend = JSON.stringify({ 'DistrictID': $('#ContentPlaceHolder1_hdnid').val(), 'utid': ddl, 'form': form, 'UserID': UserID, 'BranchID': BranchID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function DeleteRegion() {
            var UserID = localStorage.getItem("UserID");
            var BranchID = localStorage.getItem("BranchID");            
            var dataToSend = JSON.stringify({ 'DistrictID': $('#ContentPlaceHolder1_hdnid').val(), 'UserID': UserID, 'BranchID': BranchID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
        ...
        function Duplicate() {
            ...
            var form = $('#ContentPlaceHolder1_ddlForm').val();
            var BranchID = localStorage.getItem("BranchID");            
            var dataToSend = JSON.stringify({ 'utid': ddl, 'form': form, 'BranchID': BranchID });
            var results = $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2>Create User Type Form <%--<small>different form elements</small>--%></h2>
